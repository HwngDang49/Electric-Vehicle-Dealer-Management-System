...
const NotificationManagement = ({ onBack }) => {
      ...
      try {
        ...
        submitPOs.forEach((po) => {
          ...
          notificationsList.push({
            ...
            message: `Đơn hàng ${po.poCode || po.PoCode || `PO${po.poId || po.PoId}`} đang chờ xử lý`,
      ...
      try {
        ...
        ordersData.forEach((order) => {
          ...
          notificationsList.push({
            ...
            message: `Đơn hàng ${order.orderCode || `DH${order.orderId}`} đã sẵn sàng để giao hàng`,
  ...
  const markAllAsRead = () => {
    ...
    localStorage.setItem("evmStaffReadNotificationIds", JSON.stringify(allNotificationIds));
  ...
  const handlePageChange = (page) => {
    if (page >= 1 && page <= totalPages) {
      ...
      const notificationList = document.querySelector('.evm-staff-notification-list');
      if (notificationList) {
              ...
              {currentNotifications.map((notification) => (
                ...
                >
                  ...
                  <div className="evm-staff-notification-content-item">
                    ...
                    {(notification.poCode || notification.orderCode || notification.invoiceNo) && (
