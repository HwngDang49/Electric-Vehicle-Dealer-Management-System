...
const DealerSidebar = ({ activeSection, setActiveSection, userName, userEmail }) => {
  ...
  return (
    <div className={`dealer-sidebar ${isCollapsed ? 'collapsed' : ''}`}>
      ...
      <div 
        ...
        title={isCollapsed ? `${userName || "Dealer Staff"}\n${userEmail || "staff@dealer.com"}` : ''}
      >
        <div className="user-avatar">
          <img src={`https://ui-avatars.com/api/?name=${encodeURIComponent(userName || 'Dealer Staff')}&background=20c997&color=fff`} alt="User" />
