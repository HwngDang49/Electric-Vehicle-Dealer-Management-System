...
const QuotationDetailView = ({
  ...
  const basePrice = quotation.pricingDetails?.basePrice || quotation.amount;
  const discountAmount = quotation.pricingDetails?.discountAmount || 0;
          ...
          <div className="quotation-details">
            ...
            <div className="quotation-info-column">
              ...
              <div className="quotation-detail-section">
                ...
                <div className="quotation-detail-grid">
                  <div className="quotation-detail-item">
                    <span className="quotation-detail-label">Dòng xe</span>
                    <span className="quotation-detail-value">
                  ...
                  <div className="quotation-detail-item">
                    <span className="quotation-detail-label">Phiên bản</span>
                    <span className="quotation-detail-value">
                      {quotation.vehicle?.version ||
